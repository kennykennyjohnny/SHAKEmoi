...
export function PlayerBar({ track, onClose, musicService = 'spotify' }: PlayerBarProps) {
  ...
  return (
    <motion.div
      ...
      animate={{ y: 0 }}
      exit={{ y: 100 }}
      className="border-t border-purple-900/30 bg-[#1E1440]/95 backdrop-blur-lg"
    >
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <button
              ...
              className={`transition-colors ${isLiked ? 'text-pink-500' : 'text-purple-300/60 hover:text-pink-500'}`}
            >
